...
const loginFeedback = "Логін повинен містити не менше 3 символів";
const passwordFeedback = "Пароль повинен містити не менше 6 символів";
...
export default function SignUp() {
    ...
    const valids = {
        ...
        login: formData.login.trim().length >= 3,
    ...
    return <div className='reg-form-content mx-3 my-4'>
        ...
        <div className="input-group mb-3">
            ...
            <input className={"form-control " + (formData.login.length == 0 ? "" : valids.login ? "is-valid" : "is-invalid")}
